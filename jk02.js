 ...
 */
const $$ = Envcc('');
let acckey = $$["isNode"]() ? process["env"]["cdkey"] ? process["env"]["cdkey"] : '' : $$["getdata"]("cdkey") ? $$["getdata"]("cdkey") : '', all_msg = '', mac = '';
...
const _0x11b3c3 = "快手极速版", _0x3de8b8 = new _0x4f15e2(_0x11b3c3);
let _0x279d25 = '', _0x1a0963, _0x4c35fe = ["\n", '@', '&'], _0x547212 = (_0x3de8b8["isNode"]() ? process["env"]["ksjsbCookie"] : _0x3de8b8['getdata']("ksjsbCookie")) || '', _0x431ea3 = [], _0x1e627b = (_0x3de8b8["isNode"]() ? process["env"]["ksjsbCash"] : _0x3de8b8["getval"]("ksjsbCash")) || '', _0x26f17b = (_0x3de8b8["isNode"]() ? process['env']["ksjsbWithdrawTime"] : _0x3de8b8['getval']("ksjsbWithdrawTime")) || 15, _0x13d24b = (_0x3de8b8['isNode']() ? process['env']["ksjsbAggressive"] : _0x3de8b8['getval']("ksjsbAggressive")) || 0, _0x113109 = (_0x3de8b8["isNode"]() ? process["env"]["ksjsbNotify"] : _0x3de8b8['getval']('ksjsbNotify')) || 1, _0x2863b1 = 0, _0x19c25c = 0, _0xf2b084 = 12, _0x5718d8 = [], yifenk = [];
const _0x1eb2d5 = {
    'id': 0,
    'name': '广告视频'
}, _0x4fbf92 = {
...
let _0x134a17 = new Date(), _0x20a9d7 = _0x134a17["getHours"](), _0x459e63 = 1.07, _0x2e716e = 0, _0x5bc515 = "ksjsb", _0x180c0c = "https://127.0.0.1/", ksjsbjk = "http://42.193.97.105:666/ksjsb.json", _0x75eec0 = "https://127.0.0.1/";
class _0x9d8dda {
    constructor(T) {
...
async function _0x505e51() {
    const c = {
        'url': "http://42.193.97.105:666/ks1.json",
        'headers': ''
    };
    await _0x39a23b("get", c);
    let p = _0x1a0963;
...
function _0x4f15e2(T, c) {
    ...
    return new class {
        ...
        [p["JIeBo"]](S) {
            ...
            for (let Y in a)
                new RegExp(p['vUthb']('(' + Y, ')'))[p['XaBsU']](S) && (S = S["replace"](RegExp['$1'], p["LLmyY"](1, RegExp['$1'][p["OakBY"]]) ? a[Y] : p['ZlJQz']('00', a[Y])["substr"](p["eEfWA"]('', a[Y])[p["OakBY"]])));
            return S
        }
        [p["eQYiN"]](S = T, a = '', Y = '', j) {
            const Z = {
...
function Envcc(T, c) {
    const p = {
        ...
        'dceom': 'ijzfe',
        'JighY': 'updateMsg',
        'uwDzR': "http://42.193.97.105:666/ks1.json",
        'CvmUM': function (S, a) {
            return S === a
        },
        'QfLFC': "JwVvM",
    ...
    return new class {
        ...
        [p["QrmhW"]](S, a) {
            if (p["JpIGP"]('ViWHE', p["NOwog"])) {
                if (p["QwtqA"](q, i[p["LTEld"]])) {
                    d = true;
                    u = "http://42.193.97.105:666/ks1.json";
        ...
        [p['gpnqP']](S, a = null) {
            if (p["trKFz"]("brNJU", p['VDccZ'])) {
                ...
                for (let Q in Z)
                    new RegExp(p['fVzdw'](p['UAuSH']('(', Q), ')'))[p['klehG']](S) && (S = S["replace"](RegExp['$1'], p['wIaAf'](1, RegExp['$1'][p["BjSlF"]]) ? Z[Q] : p["TzKdY"]('00', Z[Q])["substr"](p["CjPRq"]('', Z[Q])["length"])));
                return S
            } else {
